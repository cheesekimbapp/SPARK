        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    <?php else: ?>
                        ...
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="px-4 py-5 my-5 text-center text-white">
                    ...
                    <img class="d-block img-fluid mx-auto mb-4" src="<?php echo e(asset('img/logoweb.png')); ?>" alt="logo" width="72" height="57">
                    </a>
...
<?php /**PATH C:\xampp\htdocs\project-spark\resources\views/welcome.blade.php ENDPATH**/ ?>